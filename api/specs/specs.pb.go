...
const file_api_specs_specs_proto_rawDesc = "" +
	"\n" +
	"\x15api/specs/specs.proto\x12\ftruenasspecs\"\xc2\x02\n" +
	...
	"\x15additional_zvol_paths\x18\t \x03(\tR\x13additionalZvolPathsJ\x04\b\b\x10\tJ\x04\b\n" +
	"\x10\vR\x15last_upgrade_snapshotR\x10nfs_dataset_pathB=Z;github.com/bearbinary/omni-infra-provider-truenas/api/specsb\x06proto3"
